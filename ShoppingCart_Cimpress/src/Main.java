class Main {
    public static void main(String[] args) {
        ...
        // Add discounts
        cart.addDiscount(25.0, "ALL"); // 25% off all items
        cart.addItem(new BaseProduct("T-shirt", 24.99, ProductType.CLOTHING, 1));
        cart.addDiscount(10.0, "NEXT"); // 20% off next item
        cart.addDiscount(15.0, "TYPE", ProductType.FOOD); // 30% off next food item
        cart.addItem(new BaseProduct("T-shirt", 24.99, ProductType.CLOTHING, 1));
        // Add more items
